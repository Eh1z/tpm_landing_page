...
const App = () => {
  return (
    ...
    <div className=' flex-col w-full h-auto bg-[#00000E] text-white overflow-hidden'>
      ...
      <img  className='absolute blur-3xl bottom-[-3200px] right-0' src={images.yblur} alt="yellow blur" />
      <img  className='absolute blur-3xl bottom-[-4600px] left-0 hidden md:block' src={images.gblur} alt="" />

      <Contact />
      <img  className='absolute blur-3xl top-[5200px] right-0 hidden md:block' src={images.bbblur} alt="blue blur" />
    </div>
    </>
  )
}
