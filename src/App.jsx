...
const App = () => {
  return (
    ...
    <div className=' flex-col w-full h-auto bg-[#00000E] text-white overflow-hidden'>
      ...
      <img  className='absolute blur-3xl bottom-[-4500px] left-0' src={images.gblur} alt="" />

      <Contact />
      <img  className='absolute blur-3xl top-[5200px] right-0' src={images.bbblur} alt="blue blur" />
    </div>
    </>
  )
}
