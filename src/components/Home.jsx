...
const Home = () => {
  return (
    <div className='flex flex-col justify-center w-full h-[100vh] sm:h-[80vh] px-3 mt-10' id='home_nav'>

      <div className='flex-col flex items-center z-10'>
      <img  className='absolute w-full translate-y-[-30px]' src={images.wave} alt="wave" />
      <div className='head_text font-russo text_gradient mb-5'>The Promised Moon Token is Here</div>
