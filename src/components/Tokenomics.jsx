  ...
  return (
    <div className='token align-left'>
      ...
      <div className='w-full '>
        <h3 className='font-russo text-xl md:text-3xl py-2'>Total Supply: <span className='text_gradient'>1,000,000,000 units</span></h3>
        <p className=' w-full leading-8 font-russo font-medium text-lg md:text-2xl'>10% to pay for services.</p>
        <h3 className='font-russo text-xl md:text-3xl py-5'>Max. Sell: <span className='text_gradient'>1,000,000 units (0.1%)</span></h3>
      </div>
