...
const Contact = () => {
  return (
    <div className=' contact flex flex-col items-center justify-center w-full py-16 xl:py-32' id='contact_nav'>
     ...
     <a href='https://t.me/TPMBSC' ><div className='flex flex-col items-center justify-center hover:scale-110 transition-all duration-700 animate-pulse cursor-pointer'>
